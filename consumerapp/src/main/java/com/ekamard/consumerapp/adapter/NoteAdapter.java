package com.ekamard.consumerapp.adapter;
...
import com.ekamard.consumerapp.CustomOnItemClickListener;
import com.ekamard.consumerapp.NoteAddUpdateActivity;
import com.ekamard.consumerapp.R;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    public NoteAdapter(Activity myActivity) {
    ...
    public void onBindViewHolder(@NonNull NoteAdapter.NoteViewHolder holder, int position) {
        ...
        holder.cvNote.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Intent intent = new Intent(myActivity, NoteAddUpdateActivity.class);
                intent.putExtra(NoteAddUpdateActivity.EXTRA_POSITION, position);
                intent.putExtra(NoteAddUpdateActivity.EXTRA_NOTE, listNotes.get(position));
                myActivity.startActivityForResult(intent, NoteAddUpdateActivity.REQUEST_UPDATE);
            }
        }));
    }
