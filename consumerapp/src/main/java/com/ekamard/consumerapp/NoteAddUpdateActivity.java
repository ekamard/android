...
public class NoteAddUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isEdit) {
            //Uri yang di peroleh di sini akan digunakan untuk get data dari provider dengan menggunakan id sebagai parameter nya
            // uri yang tercipta dari code di bawah content://com.ekamard.mynotesapp/note/id
            uriWithId = Uri.parse(CONTENT_URI + "/" + note.getId());
            if (uriWithId != null) {
                //mengisi objek cursor dengan data dari db dengan cara memanggil metode content resolver pada noteprovider
                Cursor cursor = getContentResolver().query(uriWithId, null, null, null, null);

                if (cursor != null) {
                    //untuk mengonversi data berupa cursor dan mengconvert nya menjadi cursor
