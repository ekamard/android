...
public class MainActivity extends AppCompatActivity implements LoadNotesCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Untuk menangkap pesan notifikasi bahwa ada perubahan data pada content provider dengan membuat thread baru agar tidak mengganggu thread utama
        HandlerThread handlerThread = new HandlerThread("DataObserver");
        handlerThread.start();
        Handler handler = new Handler(handlerThread.getLooper());

        //untuk observer data yang berubah pada content resolver
    ...
    private static class LoadNotesAsync extends AsyncTask<Void, Void, ArrayList<Note>>{
        ...
        protected ArrayList<Note> doInBackground(Void... voids) {
            ...
            //lalu di rubah dari objek cursor menjadi array lis sehingga data bisa di tampilkan
    ...
    public static class DataObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            //pada saat ada perubahan data onChange() pada ContentObserver maka akan memanggil LoadNotesAync secara asynchronous untuk menampilkan data terbaru
